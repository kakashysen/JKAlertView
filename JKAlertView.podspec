#
#  Be sure to run `pod spec lint JKAlertView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Jose Aponte"
  # s.authors            = { "Jose Aponte" => "joseapontec@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/kakashysen/JKAlertView.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "JKAlertView", "JKAlertView/**/*.{h,m}"
